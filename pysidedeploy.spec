...
# application icon
icon = /Users/tanarat.sh/GitHub-Repository/tanarat-cam-control/.venv/lib/python3.12/site-packages/PySide6/scripts/deploy_lib/pyside_icon.icns

[python]

# python path
python_path = /Users/tanarat.sh/GitHub-Repository/tanarat-cam-control/.venv/bin/python
...
macos.permissions = NSCameraUsageDescription:Cam Control needs camera access for the live preview and photo/video/time-lapse capture,NSMicrophoneUsageDescription:Cam Control needs microphone access to record audio with videos
